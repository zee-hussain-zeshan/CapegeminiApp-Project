...
class AssessmentsControllerTest < ActionController::TestCase
  ...
  test "should create assessment" do
    assert_difference('Assessment.count') do
      post :create, assessment: { assessment_name: @assessment.assessment_name, max_points: @assessment.max_points, module_id: @assessment.module_id }
    end
  ...
  test "should update assessment" do
    patch :update, id: @assessment, assessment: { assessment_name: @assessment.assessment_name, max_points: @assessment.max_points, module_id: @assessment.module_id }
    assert_redirected_to assessment_path(assigns(:assessment))
  end
